...
``` r
## two pounds here is a regular code comment, that will remain as such
# one pound here is a regular code comment, that will remain as such
```

2 pounds and capost here is a regular code comment, that will remain as such
...
![](foo2_files/figure-markdown_github/dotchart-1.png)
